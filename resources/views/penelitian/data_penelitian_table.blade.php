...
@section('page-content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Data Penelitian :
                                {{ $jml_penelitian }}
                                Data
                            </h5>
                        </div>
                        <div class="card-body">
                            @if (Auth::check() && Auth::user()->aktor_id == '1')
                                <ol class="col-12 mt-2 mb-2">
                                    <x-table.button-table title="Penelitian" data-target-import="#importDataPenelitian"
                                        data-target-baru="#modal-lg"
                                        href-template="{{ asset('file_penelitian/Penelitian.xlsx') }}"></x-table.button-table>
                                </ol>
                            @endif
                            <ol class="col-12 mt-2 mb-2">
                                <form action="{{ route('data_penelitian_table') }}" method="GET">
                                    <div class="row">
                            ...
                            <div class="tab-content p-0">
                                <br />
                                <x-table.datatable-wrapper tableId="data_penelitian_table">
                                    <x-slot name="thead">
                                        <tr align="center">
                                            ...
                                            <th class="th-sm">Capaian Luaran Tambahan</th>
                                            @if (Auth::check() && Auth::user()->aktor_id == '1')
                                    ...
                                    @foreach ($penelitian as $index => $item)
                                        <tr>
                                            ...
                                            <td>{{ $item['nama_institusi_penerima_dana'] ?? '-' }}</td>
                                            ...
                                            <td>{{ $item['capaian_luaran_tambahan'] ?? '-' }}</td>
                                            @if (Auth::check() && Auth::user()->aktor_id == '1')
    ...
    <!-- Modal Import -->
    <x-modals.import-excel modalId="importDataPenelitian" title="Data Penelitian"
        action="{{ route('import_data_penelitian_table') }}" template-url="{{ asset('file_penelitian/Penelitian.xlsx') }}"
        template-text="Download Template Excel" />

    <!-- Modal Create -->
    <x-modals.create modalId="modal-lg" title="Tambah Data Penelitian Baru" action="{{ route('tambah_data_penelitian_table') }}"
        size="xl">
        <div class="card-body">
            ...
            <div class="form-group row">
                <label for="judul_penelitian_create" class="col-sm-2 col-form-label d-flex align-items-center">Judul Penelitian</label>
            ...
            <h6>Luaran</h6>
            <div class="form-group row">
                <label for="luaran_wajib" class="col-sm-2 col-form-label d-flex align-items-center">Luaran Wajib</label>
                <div class="col-sm-10 d-flex align-items-center">
                    <input type="text" class="form-control" id="luaran_wajib" name="luaran_wajib"
                        placeholder="Isikan Luaran Wajib">
                </div>
            </div>

            <div class="form-group row">
                <label for="capaian_luaran_wajib" class="col-sm-2 col-form-label d-flex align-items-center">Capaian Luaran Wajib</label>
                <div class="col-sm-10 d-flex align-items-center">
            ...
            <div class="form-group row">
                <label for="luaran_tambahan" class="col-sm-2 col-form-label d-flex align-items-center">Luaran Tambahan</label>
                <div class="col-sm-10 d-flex align-items-center">
            ...
            <div class="form-group row">
                <label for="capaian_luaran_tambahan" class="col-sm-2 col-form-label d-flex align-items-center">Capaian Luaran Tambahan</label>
                <div class="col-sm-10 d-flex align-items-center">
                    <input type="text" class="form-control" id="capaian_luaran_tambahan" name="capaian_luaran_tambahan"
                        placeholder="Isikan Capaian Luaran Tambahan">
                </div>
            </div>
    ...
    <!-- Modals Edit & Delete -->
    @foreach($penelitian as $index => $item)
        <x-modals.edit modalId="edit{{ $item['id'] }}" title="Edit Data Penelitian" action="{{ route('edit_data_penelitian_table') }}"
            size="xl">
            <div class="card-body">
                ...
                <h6>Luaran</h6>
                <div class="form-group row">
                    <label for="luaran_wajib_edit" class="col-sm-2 col-form-label d-flex align-items-center">Luaran Wajib</label>
                    <div class="col-sm-10 d-flex align-items-center">
                        <input type="text" class="form-control" id="luaran_wajib_edit" name="luaran_wajib"
                            value="{{ $item['luaran_wajib'] }}">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="capaian_luaran_wajib_edit" class="col-sm-2 col-form-label d-flex align-items-center">Capaian Luaran Wajib</label>
                    <div class="col-sm-10 d-flex align-items-center">
                ...
                <div class="form-group row">
                    <label for="luaran_tambahan_edit" class="col-sm-2 col-form-label d-flex align-items-center">Luaran Tambahan</label>
                    <div class="col-sm-10 d-flex align-items-center">
                ...
                <div class="form-group row">
                    <label for="capaian_luaran_tambahan_edit" class="col-sm-2 col-form-label d-flex align-items-center">Capaian Luaran Tambahan</label>
                    <div class="col-sm-10 d-flex align-items-center">
                        <input type="text" class="form-control" id="capaian_luaran_tambahan_edit"
                            name="capaian_luaran_tambahan" value="{{ $item['capaian_luaran_tambahan'] }}">
                    </div>
                </div>
        ...
        <x-modals.delete modalId="delete{{ $item['id'] }}" message="Apakah Anda yakin ingin menghapus data ini?"
            action="{{ route('hapus_data_penelitian_table', $item['id']) }}" />
    @endforeach
    {{-- DataTables Config - Simplified for many columns --}}
    <x-table.datatable-config tableId="data_penelitian_table" :hasExport="true" />
    {{--
    <script>
        $(function () {
