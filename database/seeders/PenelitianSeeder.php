...
class PenelitianSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $worksheet = $spreadsheet->getSheetByName('PNLT MASTER DATA');
        ...
        foreach ($rows as $rowIndex => $row) {
            ...
            $namaInstitusiIndex = $findColumn(['Nama Institusi Penerima Dana', 'Institusi Penerima Dana', 'nama_institusi_penerima_dana']);
            ...
            $penelitian = Penelitian::create([
                ...
                'nama_institusi_penerima_dana' => $getValue($headers, $row, $namaInstitusiIndex),
